function [idxbest, Cbest, sumDbest, Dbest] = kmeans2(X, k, varargin)
...
if hadNaNs
    ...
    function cellout = loopBody(rep,S)
        ...
        try % catch empty cluster errors and move on to next rep
            ...
            if ~converged
                if reps==1
                    warning(message('stats:kmeans:FailedToConverge', 1000));
                else
                    warning(message('stats:kmeans:FailedToConvergeRep', 1000, rep));
                end
            end
